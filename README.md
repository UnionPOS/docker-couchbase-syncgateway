<!--
  ...
  **
  ...
  -->
# Docker Couchbase Sync Gateway



Dockerfile for Couchbase Sync Gateway
...
1. `git clone https://github.com/UnionPOS/docker-couchbase-syncgateway` to pull down the repository
...
Please use the [issue tracker](https://github.com/UnionPOS/docker-couchbase-syncgateway/issues) to report any bugs or file feature requests.
